...
ICONS_DIR = RESOURCES_DIR / "images"
...
class MainWindow(QMainWindow):
    ...
    def _setup_notifications(self):
        """Conecta o serviço de notificação a um slot para exibir o banner."""
    ...
    def _show_notification(self, message: str, notification_type: str):
        """Cria e exibe o banner de notificação."""
        NotificationBanner(
            message=message, 
    ...
    def _create_content_area(self):
        """Popula o QStackedWidget com todas as views da aplicação."""
    ...
    def _create_nav_panel(self) -> QFrame:
        """Cria e retorna o painel de navegação lateral."""
        nav_panel = QFrame()
        ...
        if logo_path.exists():
            ...
            logo_label.setPixmap(pixmap.scaled(
                180, 120, Qt.AspectRatioMode.KeepAspectRatio, Qt.TransformationMode.SmoothTransformation
            ))
        logo_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
        logo_label.setContentsMargins(0, 10, 0, 20)
        ...
        # Define a primeira view como ativa, o que acionará a animação inicial
        self.nav_list.setCurrentRow(0)

        return nav_panel

    def on_nav_item_changed(self, current_item: QListWidgetItem, previous_item: QListWidgetItem):
        """Troca para o widget selecionado com animação."""
        if current_item:
