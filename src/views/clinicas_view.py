...
class ClinicasView(QWidget):
    ...
    def _setup_ui(self):
        ...
        self.add_btn = QPushButton("Adicionar Clínica")
        add_layout.addWidget(QLabel("<b>Nova Clínica:</b>"), 0, 0)
        ...
        self.list_widget.setObjectName("clinicasList")
        remove_layout = QHBoxLayout()
        self.remove_btn = QPushButton("Remover Selecionada(s)")
